        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8">
          ...
          {wallet && (
            <button
              ...
              disabled={loading}
              className="bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-700 hover:to-emerald-700 text-white px-6 py-3 rounded-xl font-semibold flex items-center space-x-2 transition-all disabled:opacity-50"
            >
                  ...
                  <div>
                    ...
                    <div className="flex items-center text-sm text-gray-400 space-x-4">
                      ...
                      <div className="flex items-center space-x-1">
                        ...
                        <span>{getDate((poll.createdAt).toString())}</span>
                      </div>
                    </div>
          ...
          <div className="bg-gray-900 rounded-2xl p-6 w-full max-w-md border border-white/20">
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  type="text"
                  value={newPollNftMint}
                  onChange={(e) => setNewPollNftMint(e.target.value)}
